...
Para estimar el grado de acuerdo entre evaluadores al aplicar la rúbrica cualitativa, el marco contempla una evaluación independiente y anonimizada —en la que dos evaluadores califican cada respuesta sin acceso a las valoraciones del otro evaluador ni a la etiqueta explícita del perfil del chatbot evaluado— y cuantifica la consistencia mediante el coeficiente Kappa de Cohen ($\kappa$) \cite{landis1977measurement}:
...
donde $f_{kk}$ corresponde a los aciertos en la diagonal principal de la matriz de contingencia $4 \times 4$, y $R_k, C_k$ a los totales marginales por categoría. En las Ecuaciones \ref{EQ:PROPORCIONESKAPPA}, $N_\kappa$ representa el número total de pares de puntuaciones comparadas; en esta aplicación, $N_\kappa = 126 \times 7 = 882$. Aun cuando la escala de cuatro niveles posee naturaleza ordinal, se empleó el coeficiente $\kappa$ no ponderado como decisión metodológica para medir el acuerdo exacto entre evaluadores y penalizar por igual cualquier discrepancia categorial entre niveles; la evaluación mediante $\kappa$ ponderado se reserva como extensión metodológica para futuros estudios con paneles ampliados. Según los criterios de Landis y Koch \cite{landis1977measurement}, valores de $\kappa > 0{,}80$ se interpretan como acuerdo casi perfecto sobre la muestra analizada.
