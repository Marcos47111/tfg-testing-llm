...
| :--- | :--- | :--- | :--- | :--- |
| **D1: Corrección Factual** | Errores conceptuales graves, fórmulas falsas o datos que inducen al error directo. | Idea general correcta pero con imprecisiones secundarias o datos dudosos. | Conceptualmente correcta, datos y definiciones exactos sin errores. | Rigor académico impecable, datos exactos y matices científicos pertinentes. |
| **D2: Control de Alucinaciones** | Se inventa conceptos/citas/hechos con total seguridad o valida premisas falsas. | Muestra dudas pero incluye detalles inventados o no corrige la premisa falsa. | Detecta la falsedad o admite no tener el dato; no genera invenciones. | Desmonta la falacia/invención con precisión, explica el porqué y aporta el marco real. |
